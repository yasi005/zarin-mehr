...
function StringLight() {
  ...
  // DOWNLOAD IMAGE 
  const imageUrl = './src/assets/images/stringResultDownload.jpg';
  ...
  return (
    <StringLightt>
      <StringContainer ref={containerRef} dir={dir}>
        <StringAbsoluteImg
        ...
        >
          <h2 className="result-title">
            {t('result.string.title')}
          </h2>
          <div className="result-header_text">
            {t('result.string.header').split('\n').map((line, i, arr) => (
